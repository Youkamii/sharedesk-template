...
- フォルダごとに共有メモを残せます。
- 招待コードで人を招き、いま接続している人を確認できます。
- 一人ひとりに管理者・編集可能・アップロード可能・閲覧のみの4段階の役割を割り当てられ、管理者画面からいつでも変更できます。
- 画面の言語は英語・韓国語・日本語・ヒンディー語・中国語の5種類です。管理者が設定タブでデスクの言語を決め（既定は英語）、「個別の言語を許可」をオンにすれば参加者も自分の画面の言語を選べます。
