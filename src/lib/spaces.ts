...
//
// 슬러그·이름의 순수 규칙은 space-slug.ts에 있다 — edge의 proxy도 그 판정을
// 쓰기 때문에 저장소 import가 없는 모듈로 분리했다.

export { MAX_SPACE_NAME_LENGTH, parseSpaceName, parseSpaceSlug, RESERVED_SLUGS };
