...
| **黎明** | **夜潮** |
| ![黎明壁纸](./docs/sharedesk-wallpaper-dawn.png) | ![夜潮壁纸](./docs/sharedesk-wallpaper-tide.png) |
...
- 界面支持五种语言——英语、韩语、日语、印地语和中文。管理员在设置中确定桌面语言（默认英语），也可以允许每位成员选择自己的语言。
- 从四种壁纸中挑选合心情的一种；选择会保存在每个人的浏览器里。

## 如何共享?

```text
  主持人一个人的 Google Drive
             ↕
     同一个 ShareDesk 地址
   ├─ 主持人的 Google 账号
   ├─ 参与者 A 的 Google 账号
...
只有主持人的账号会连接 Google Drive。参与者用各自的 Google 账号登录，但在 ShareDesk 里，大家共同使用主持人指定的那一个 Drive 文件夹的文件和容量。ShareDesk 绝不会读取参与者个人的 Drive 文件。

用户、邀请、文件夹备忘、图标布局等共享状态也保存在主持人的 Drive 里，不需要单独的数据库。

## 开始使用

- **如果觉得配置太难：** [让 AI 帮你搭建](./docs/AI_INSTALL.md)
- **想自己运行生产服务器：** [详细安装指南](./docs/INSTALL.md)
- **已经安装过：** [更新指南](./docs/UPDATE.md)
- **只想在自己电脑上一个人使用：** [本地个人使用](./docs/LOCAL.md)

受邀的参与者不需要安装任何东西。打开主持人发来的 ShareDesk 地址登录，输入邀请码即可。
